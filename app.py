...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    with tab1:
        ...
        def make_chart(zone_key):
            ...
            # Divider line
            if fc_dates:
                split_x = fc_dates[0] if hasattr(fc_dates[0], 'strftime') else fc_dates[0]
                fig.add_vline(x=str(split_x)[:10], line_dash='dot',
                              line_color='#3a2a5a', annotation_text='forecast →',
                              annotation_font_color='#5a4a7a', annotation_font_size=10)
