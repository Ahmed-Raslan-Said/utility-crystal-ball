...
# ═══ STEP 4 — DATA EXPLORER ═══════════════════════════════════════
    ...
    with tabs[2]:
        ...
        if daily:
            ...
            fig_dow.update_layout(title=dict(text="Day of week pattern",font=dict(color="#c0a0ff",size=12)),showlegend=False,**{k:v for k,v in cb.items() if k!="hovermode"},height=300)
